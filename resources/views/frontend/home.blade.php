                    ...
                    <div class="fh5co_hover_news_img">
                        <div class="fh5co_hover_news_img_video_tag_position_relative">
                            ...
                            <div class="fh5co_hover_news_img_video_tag_position_absolute fh5co_hide_4">
                                <img src="{{asset('frontend/images/vil-son-35490.jpg')}}" alt=""/>
                            </div>
        ...
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img src="{{asset('frontend/images/nathan-mcbride-229637.jpg')}}" alt=""/></div>
                            <div></div>
                        </div>
                    </div>
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img src="{{asset('frontend/images/ryan-moreno-98837.jpg')}}" alt=""/></div>
                            <div></div>
                        </div>
                    </div>
                    <div class="col-md-7">
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img">
                                <img src="{{asset('frontend/images/photo-1449157291145-7efd050a4d0e-578x362.jpg')}}" alt=""/>
                            </div>
                            <div></div>
                        </div>
                    </div>
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img src="{{asset('frontend/images/office-768x512.jpg')}}" alt=""/></div>
                            <div></div>
                        </div>
                    </div>
                    <div class="col-md-7">
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <img src="{{asset('frontend/images/download (1).jpg')}}" alt="img" class="fh5co_most_trading"/>
                    </div>
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <img src="{{asset('frontend/images/allef-vinicius-108153.jpg')}}" alt="img" class="fh5co_most_trading"/>
                    </div>
                    <div class="col-7 paddding">
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <img src="{{asset('frontend/images/download (2).jpg')}}" alt="img" class="fh5co_most_trading"/>
                    </div>
                    <div class="col-7 paddding">
                        <div class="most_fh5co_treding_font"> Magna aliqua ut enim ad minim veniam quis nostrud.</div>
                        <div class="most_fh5co_treding_font_123"> April 18, 2016</div>
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center"><img src="{{asset('frontend/images/seth-doyle-133175.jpg')}}" alt="img"
