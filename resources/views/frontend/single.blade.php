...
@section('title','post')
@section('content')
<div id="fh5co-title-box" style="background-image: url({{asset('frontend/images/camila-cordeiro-114636.jpg')}}); background-position: 50% 90.5px;" data-stellar-background-ratio="0.5">
