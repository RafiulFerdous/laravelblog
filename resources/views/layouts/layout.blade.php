        ...
        <nav class="navbar navbar-toggleable-md navbar-light ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="/post">Single <span class="sr-only">(current)</span></a>
                    </li>
    ...
    <div class="container animate-box">
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-4 ">
                ...
                <a href="#" class="footer_img_post_6"><img src="{{asset('frontend/images/allef-vinicius-108153.jpg')}}" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="{{asset('frontend/images/32-450x260.jpg')}}" alt="img"/></a>
